...
BUILD_TARGETS = \
	...
	speculative infill tokenize benchmark-matmult parallel finetune export-lora lookahead multiple-prompts tests/test-c.o
...
multiple-prompts: examples/multiple-prompts/multiple-prompts.cpp ggml.o llama.o $(COMMON_DEPS) $(OBJS)
	$(CXX) $(CXXFLAGS) $(filter-out %.h,$^) -o $@ $(LDFLAGS)
